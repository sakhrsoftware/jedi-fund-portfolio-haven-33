      ...
      <div className="flex-grow container mx-auto px-4 pt-24 pb-16">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="space-y-6 text-jedi-white/90 text-xl leading-relaxed">
            ...
            <p>Previously, Fahad founded the advisory firm TechInvest in 2015 to provide opportunities for Middle East investors and sovereigns to access private technology opportunities. TechInvest advised and/or structured investments totaling over $900M and offered market assessment services to prominent VC & PE firms and emerging managers.</p>
          </div>
        </div>
      </div>
