      ...
      <div className="flex-grow container mx-auto px-4 pt-24 pb-16">
        ...
        duration: 0.6
          ...
          <div className="space-y-8 text-neutral-400 text-lg leading-relaxed font-light">
            <p>Fahad is Vice Chairman of Kamco Investment Company & General Partner of Kamco JEDI program, targeting investments in SF Bay Area-based emerging VCs and technology companies.</p>
            
            <p>Previously Fahad founded the advisory firm TechInvest in 2015, providing opportunities for Middle East investors and sovereign wealth funds to access private tech opportunities. TechInvest advised and/or structured investments totaling over $900M and offered market assessment services to prominent VC & PE firms and emerging managers.</p>
          </div>
        </motion.div>
      </div>
