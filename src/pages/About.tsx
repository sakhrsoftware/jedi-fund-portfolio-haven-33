      ...
      <div className="flex-grow container mx-auto px-4 pt-24 pb-16">
        ...
        duration: 0.6
          ...
          <div className="space-y-8 text-neutral-400 text-lg leading-relaxed font-light">
            <p>Fahad is Vice Chairman of Kamco Investment Company & General Partner of Kamco JEDI program, targeting investments in SF Bay Area-based emerging VCs and tech companies.</p>
