...
const PORTFOLIO_COMPANIES = [{
  ...
  sector: "LP",
  description: "Founded by Yuri Sagalov",
  image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?auto=format&fit=crop&w=800&q=80"
}, {
  id: 2,
  name: "Weekend Fund",
  sector: "LP",
  description: "Founded by Ryan Hoover; LP in Fund I (Deel)",
    ...
    <div className="min-h-screen bg-white dark:bg-black flex flex-col">
      <div className="flex-grow container mx-auto px-4 pt-20 pb-16">
        <div className="mb-16 text-center">
          <h1 className="text-4xl font-light tracking-wide text-black dark:text-neutral-50 mb-4 text-left">portfolio</h1>
        </div>
      ...
      <footer className="bg-white dark:bg-black border-t border-black/10 dark:border-[#333333] py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center space-y-4">
            <div className="flex justify-center items-center space-x-8">
              <span className="text-black/60 dark:text-jedi-white/60">SF</span>
              <span className="text-black/60 dark:text-jedi-white/60">•</span>
              <span className="text-black/60 dark:text-jedi-white/60">Kuwait City</span>
              <span className="text-black/60 dark:text-jedi-white/60">•</span>
              <span className="text-black/60 dark:text-jedi-white/60">Doha</span>
            </div>
          </div>
        </div>
      </footer>
